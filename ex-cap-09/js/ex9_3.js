//Programa "Qual é o peso da melanmcia"
...
frm.addEventListener("submit", (e) => {
    ...
    const peso = Number(frm.inPeso.value);  //conteúdo do campo peso
    ...
    mostrarAposta();  //chama function que mostra as apostas já salvas
...
const mostrarAposta = () => {
    ...
    for(let i = 0; i < nomes.length; i++) {
        //concatena e, linhas os nomes dos apostadores e suas apostas
        linhas += nomes[i] + " - " + pesos[i] + "gr \n";
    };

    //exibe as linhas (altera o conteúdo do elemento respListar)
...
frm.btLimpar.addEventListener("click", () => {
    ...
    if(confirm("Confirma exclusão de todas as apostas?")) {
        ...
        mostrarAposta();                        //exibe a listagem vazia
    };
});
